...
public class ProjectDetails 
{
	...
	public String toString() {
		return "ProjectDetails [projectId=" + projectId + ", projectName=" + projectName + ", clientName=" + clientName
				+ ", teamLeader=" + teamLeader + ", developingTechnology=" + developingTechnology
				+ ", databaseTechnology=" + databaseTechnology + ", fromDate=" + fromDate + ", toDate=" + toDate + "]";
	}
